...
public class EventService {
    ...
    public EventIdDTO createEvent(EventRequestDTO eventDTO) {
        ...
        this.eventRepositoriy.save(newEvent);
    ...
    public AttendeeIdDTO registerAttendeeOnEvent(String eventId, AttendeeRequestDTO attendeeRequestDTO) {
        ...
        if (event.getMaximumAttendees() <= atteendList.size())  throw new EventFullException("Event is full");
    ...
    private Event getEventById(String eventId) {
        return this.eventRepositoriy.findById(eventId).orElseThrow(() -> new EventNotFoundException("Event not found with ID:" + eventId));
